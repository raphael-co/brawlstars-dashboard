...
export function Navbar() {
  ...
  return (
    <header className="relative">
      {/* ombre portée sous la barre */}
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-6 translate-y-3 bg-black/30 blur-lg" />
      <div className="container mx-auto max-w-6xl px-4 min-h-[105px] sm:min-h-[130px] flex items-center justify-between gap-4">
        {/* Capsule Brawl autour de tout le header */}
            ...
            <form onSubmit={submit} className="flex-1 max-w-xl hidden md:flex items-center gap-2">
              ...
              <div className="flex-1 flex items-center gap-2 rounded-xl border-2 border-black bg-white/10 px-3 py-2 shadow-[0_4px_0_#000] backdrop-blur-sm">
                ...
                <input
                  ...
                  placeholder="Entrez votre tag (ex: #8PQL0J2)"
                  value={tag}
